    ...
    <section id="instructor" className="w-full py-16 md:py-24 lg:py-32 overflow-hidden">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="mt-12 flex justify-center">
          <MotionDiv animation="slide-in" delay={0.2} className="w-full max-w-4xl">
            <Card className="overflow-hidden shadow-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 md:flex">
              ...
              <div className="md:w-2/3">
                <CardContent className="p-8">
                  ...
                  <MotionDiv animation="fade-in-up" delay={0.7}>
                    ...
                    Vivek is a seasoned data professional with experience in building and optimizing data pipelines for tech startups and enterprise companies. He specializes in SQL performance tuning and has a knack for breaking down complex topics into easy-to-understand concepts.
                    </p>
                  </MotionDiv>
